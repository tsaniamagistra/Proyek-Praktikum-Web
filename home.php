	...
	<div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
		...
		<div class="offcanvas-body">
			<div class="list-group list-group-flush">
				...
				<a href="#" class="list-group-item list-group-item-action">Pendaftaran Periksa</a>
	...
	<div class="d-flex align-items-center justify-content-center" style="height:35vh;">
		<div class="row" style="width: 50%; text-align: center;">
			<div class="d-grid col-6">
				<button type="button" class="btn btn-dark btn-lg btn-home">Jadwal Dokter</button>
			</div>
			<div class="d-grid col-6">
				<button type="button" class="btn btn-dark btn-lg btn-home">Pendaftaran Periksa</button>
			</div>
		</div>
	</div>
